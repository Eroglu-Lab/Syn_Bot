...
//	close();
	...
	imageCalculator("AND create", currentTitle + " (blue)", currentColocTitle);
	...
	saveAs("Tiff", dirOut + File.separator + splitName[0] + "_blue_and_coloc.tif");
...
Table.save(dir1 + "blue_and_coloc_summary.csv");
