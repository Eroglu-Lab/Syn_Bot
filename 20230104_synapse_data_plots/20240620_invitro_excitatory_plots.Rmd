---
title: "20240116_invitro_excitatory_plots"
...
synquant_data <- read.csv("excitatory_invitro_data/excitatory_invitro_synquant_4.csv")
...
synquant_data[which(grepl("Control", synquant_data$Image)),]$condition <- "control"
synquant_data[which(grepl("ACM", synquant_data$Image)),]$condition <- "ACM"
...
ggplot(summarize(group_by(synquant_data, condition), mean(Colocalized.Puncta.Count)), aes(x = condition, y = `mean(Colocalized.Puncta.Count)`)) + 
  ...
  annotate("text", x = 1, y = 200, label = "p=0.002")

#ggsave("invitro_excitatory_synquant.pdf", width = 3.5, height = 5)
...
ggplot(synquant_plot.df, aes(x = condition, y = `mean(normalized_count)`)) + 
  ...
  annotate("text", x = 1, y = 2.5, label = "p=0.001") +
  geom_errorbar(aes(ymin=`mean(normalized_count)`-sem, ymax=`mean(normalized_count)`+sem), width=.2,
                 position=position_dodge(.9)) 
...
ggsave("F:/Savage_Dropbox/Duke Research Team Dropbox/Justin Savage/Team_Syn_Bot/20240318_figures/figure_5_in_vitro/invitro_excitatory_faceted.pdf", width = 4.5, height = 2.5)
...
#ggsave("F:/Savage_Dropbox/Duke Research Team Dropbox/Justin Savage/Team_Syn_Bot/20240318_figures/figure_s1_line_plots/invitro_excitatory_green_line_plot_raw.pdf", width = 5, height = 2.75)
...
#ggsave("F:/Savage_Dropbox/Duke Research Team Dropbox/Justin Savage/Team_Syn_Bot/20240318_figures/figure_s1_line_plots/invitro_excitatory_coloc_line_plot_raw.pdf", width = 5, height = 2.75)
