...
manual_synbot_data <- read.csv("simulated_data/sim_combined_percent_hist_2.csv")
ilastik_data <- read.csv("simulated_data/sim_combined_ilastik.csv")
synquant_data <- read.csv("simulated_data/sim_combined_synquant.csv")
#SynQuant params:
# zscore_thres=10
# MinSize=10
# MaxSize=100
